/////////////////////////////////////////////////////////////
//   LogisticSonar 3d v.3 base + manual + калибровка веса  //
//   Leonardo + моя плата v.2.1 + BAT sensors + 4 tenzo      //
...
int menupos_end = 3; //крайний пункт меню - EXIT, 0 - главное меню
//
  ...
  lcd.clear();
            if (lang){
              lcd.setCursor(0, 0);  lcd.print("Weight calibration");
                ...
                lcd.setCursor(9, 3); scale.set_scale(weight_key); weighting(); lcd.print(round(weight)); //lcd.print((long(weight)/10)*10); 
              }
            if (!lang){
          ...
          if (menupos == 0)  {
            ...
            if (!lang){
             lcd.createChar(1, bukva_L); lcd.createChar(2, bukva_B); lcd.createChar(3, bukva_I);
              ...
              lcd.setCursor(0, 3);  lcd.print("  B"); lcd.write(7); lcd.print("XO"); lcd.write(8);
          }  
          menu = HIGH;
          }
          if (menupos == 1)  {
