          ...
          if (menupos == 0)  {
            ...
            if (!lang){
             lcd.createChar(1, bukva_L); lcd.createChar(2, bukva_B); lcd.createChar(3, bukva_I);
              ...
              lcd.setCursor(0, menupos_end);  lcd.print("  B"); lcd.write(7); lcd.print("XO"); lcd.write(6);
          }  
          menu = HIGH;
          }
          if (menupos == 1)  {
...
long calibration()   {
        ...
        //округление по 5 измерениям
          ...
          if (!lang) {
            ...
            lcd.setCursor(0, 0); lcd.print("   ABTOKA"); lcd.write(1); lcd.write(2); lcd.write(3); lcd.print("POBKA");
